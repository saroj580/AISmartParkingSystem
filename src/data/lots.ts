...
export const PARKING_LOTS: ParkingLot[] = [
  {
    ...
    pricing: {
      TWO_WHEELER: { baseRatePerHour: 1.5, dailyMaxRate: 9, currency: "USD" },
      THREE_WHEELER: { baseRatePerHour: 2.5, dailyMaxRate: 14, currency: "USD" },
      FOUR_WHEELER: { baseRatePerHour: 4, dailyMaxRate: 26, currency: "USD" },
    },
    coverColor: "#4F46E5",
  },
  {
    ...
    pricing: {
      TWO_WHEELER: { baseRatePerHour: 1.25, dailyMaxRate: 8, currency: "USD" },
      THREE_WHEELER: { baseRatePerHour: 2.25, dailyMaxRate: 12, currency: "USD" },
      FOUR_WHEELER: { baseRatePerHour: 3.5, dailyMaxRate: 22, currency: "USD" },
    },
    coverColor: "#0EA5E9",
  },
  {
    ...
    pricing: {
      TWO_WHEELER: { baseRatePerHour: 1, dailyMaxRate: 6, currency: "USD" },
      THREE_WHEELER: { baseRatePerHour: 2, dailyMaxRate: 11, currency: "USD" },
      FOUR_WHEELER: { baseRatePerHour: 3, dailyMaxRate: 18, currency: "USD" },
    },
    coverColor: "#10B981",
  },
  {
    ...
    pricing: {
      TWO_WHEELER: { baseRatePerHour: 0.75, dailyMaxRate: 5, currency: "USD" },
      THREE_WHEELER: { baseRatePerHour: 1.5, dailyMaxRate: 9, currency: "USD" },
      FOUR_WHEELER: { baseRatePerHour: 2.5, dailyMaxRate: 15, currency: "USD" },
    },
    coverColor: "#8B5CF6",
  },
  {
    ...
    pricing: {
      TWO_WHEELER: { baseRatePerHour: 0.9, dailyMaxRate: 5.5, currency: "USD" },
      THREE_WHEELER: { baseRatePerHour: 1.75, dailyMaxRate: 10, currency: "USD" },
      FOUR_WHEELER: { baseRatePerHour: 2.75, dailyMaxRate: 16, currency: "USD" },
    },
    coverColor: "#F59E0B",
  },
  {
    ...
    pricing: {
      TWO_WHEELER: { baseRatePerHour: 1.75, dailyMaxRate: 10, currency: "USD" },
      THREE_WHEELER: { baseRatePerHour: 2.75, dailyMaxRate: 15, currency: "USD" },
      FOUR_WHEELER: { baseRatePerHour: 4.5, dailyMaxRate: 28, currency: "USD" },
    },
    coverColor: "#EC4899",
  },
];
